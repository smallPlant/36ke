"""Playwright 浏览器会话：反自动化检测与持久化用户目录支持。"""
...
from kr36.core.paths import configure_playwright_browsers
...
class IyiouBrowser:
    ...
    def __init__(
        ...
        *,
        ...
        """创建浏览器会话，headless 控制是否无头，profile 为持久化用户目录。"""
